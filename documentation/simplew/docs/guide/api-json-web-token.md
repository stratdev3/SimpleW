...
You can provide your own implementation of the `GetJwt()` by overriding in a [subclass](./callback.md#subclass).
...
This example shows how to integrate a global custom jwt verification in all controllers using [subclass](./callback.md#subclass).
