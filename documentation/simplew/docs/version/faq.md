...
But when it is actually true (see [performance comparisons](../guide/performances.md) or [TechEmpower](https://www.techempower.com/benchmarks) results), then it deserves to be used.

> Support .NET Framework

I don't want to support .NET Framework.
