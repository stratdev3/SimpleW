...
[![NuGet](https://img.shields.io/nuget/v/SimpleW.JsonEngine.Newtonsoft?color=7737d1&label=version&logo=NuGet)](https://www.nuget.org/packages/SimpleW.JsonEngine.Newtonsoft)
[![Downloads](https://img.shields.io/nuget/dt/SimpleW.JsonEngine.Newtonsoft?color=7737d1&label=downloads&logo=NuGet)](https://www.nuget.org/packages/SimpleW.JsonEngine.Newtonsoft)
