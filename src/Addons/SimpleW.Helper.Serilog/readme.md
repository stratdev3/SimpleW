...
[![NuGet](https://img.shields.io/nuget/v/SimpleW.Helper.Serilog?color=7737d1&label=version&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Helper.Serilog)
[![Downloads](https://img.shields.io/nuget/dt/SimpleW.Helper.Serilog?color=7737d1&label=downloads&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Helper.Serilog)
...
This package bridges SimpleW internal logging to Serilog.
...
namespace Sample {
    class Program {
        ...
        static async Task Main() {
            ...
            // install SimpleW -> serilog bridge
            using var bridge = SimpleWSerilogBridge.Install(logger, replaceExistingSink: false);
