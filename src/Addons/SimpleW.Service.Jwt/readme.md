...
[![NuGet](https://img.shields.io/nuget/v/SimpleW.Service.Jwt?color=7737d1&label=version&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Service.Jwt)
[![Downloads](https://img.shields.io/nuget/dt/SimpleW.Service.Jwt?color=7737d1&label=downloads&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Service.Jwt)
