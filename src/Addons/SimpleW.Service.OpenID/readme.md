...
[![NuGet](https://img.shields.io/nuget/v/SimpleW.Service.OpenID?color=7737d1&label=version&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Service.OpenID)
[![Downloads](https://img.shields.io/nuget/dt/SimpleW.Service.OpenID?color=7737d1&label=downloads&logo=NuGet)](https://www.nuget.org/packages/SimpleW.Service.OpenID)
