...
namespace SimpleW.Engine.Ioxide {
    ...
    /// </summary>
    internal sealed class IoxideRawConnection :
        ISimpleWEngine,
        ...
        public ValueTask<SimpleWTransportReadResult> ReadAsync(
        ...
        private void ThrowIfDisposed() {
            if (Volatile.Read(ref _disposed) != 0) {
                throw new ObjectDisposedException(nameof(IoxideRawConnection));
            }
        }
