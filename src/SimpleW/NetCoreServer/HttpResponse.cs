...
namespace NetCoreServer
{
    ...
    public partial class HttpResponse
    {
        ...
        /// <returns></returns>
        public static bool AddMimeTypes(string extension, string contentType) {
            return _mimeTable.TryAdd(extension, contentType);
        }
        ...
        /// Make CORS response
        /// </summary>
        /// <param name="origin">Access-Control-Allow-Origin value</param>
        /// <param name="headers">Access-Control-Allow-Headers value</param>
        /// <param name="methods">Access-Control-Allow-Methods</param>
        /// <param name="credentials">Access-Control-Allow-Credentials</param>
        public HttpResponse MakeCORSResponse(string origin = "*", string headers = "*", string methods = "GET,POST,OPTIONS", string credentials = "true") {
            Clear();
            SetBegin(204);
            SetHeader("Access-Control-Allow-Origin", origin);
            SetHeader("Access-Control-Allow-Headers", headers);
            SetHeader("Access-Control-Allow-Methods", methods);
            SetHeader("Access-Control-Allow-Credentials", credentials);
        ...
        private static Dictionary<string, string> _mimeTable;
